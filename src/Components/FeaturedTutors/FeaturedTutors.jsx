...
const FeaturedTutors = () => {
    ...
    return (
        ...
        <h1 className="font-serif text-4xl capitalize my-3">Available tutors</h1>
        <p className="font-sans font-medium text-base capitalize text-[#9896AF]">6 of our top-rated educators</p>
        <div className="flex justify-end">
            <Link href={'/tutors'} className="flex items-center gap-1.5 text-[#8F8BA7] opacity-80 hover:btn hover:bg-[#0C0C10] transition-all duration-150 rounded-xl">
        View all
