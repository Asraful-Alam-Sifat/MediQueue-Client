  ...
  return (
    <div className=" bg-[#14141A]">
      <div className="max-w-11/12 mx-auto py-10 ">
        <div className="grid grid-cols-1 items-center gap-8 lg:gap-x-30 sm:justify-between  sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="text-center sm:text-left">
            <h5 className="font-medium text-xl uppercase text-[#9694A1] font-sans">
              learning
            </h5>
            <div className="flex flex-col gap-y-1.5 mt-3">
              <Link
                href={""}
                className="text-[#54526E] font-medium text-base capitalize hover:text-white hover:opacity-95 transition-all duration-150 font-sans"
              >
                Browse tutors
              </Link>
              <Link
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex flex-col gap-y-2 mt-3 ">
              <Link
                href={""}
                className="text-[#54526E] font-medium text-base hover:text-white hover:opacity-95 transition-all duration-150 flex gap-2 items-center justify-center sm:justify-start"
              >
              ...
              <Link
                href={""}
                className="text-[#54526E] font-medium text-base capitalize hover:text-white hover:opacity-95 transition-all duration-150  flex gap-2 items-cente  justify-center sm:justify-start"
              >
        ...
        <div className=" flex flex-col sm:flex-row sm:justify-between">
          <p className="text-[#54526E] font-medium text-base capitalize font-sans text-center sm:text-start">
            <small>&copy;2026 MediQueue. All rights reserved.</small>
          </p>
          <p className="text-[#54526E] font-medium text-base capitalize font-sans text-center sm:text-start">
            <small>Made with care in Bangladesh 🇧🇩</small>
          </p>
        </div>
      </div>
    </div>
