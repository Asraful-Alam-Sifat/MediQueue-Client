      ...
      <div className="navbar-end hidden sm:flex w-full sm:w-auto flex-row items-center justify-center sm:justify-end gap-3">
        {session ? (
          <div className="relative group">
            ...
            <div className="absolute right-0 top-full mt-2 w-52 rounded-xl border border-[#20DE8B]/20 bg-[#111118] shadow-2xl shadow-black/40 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
