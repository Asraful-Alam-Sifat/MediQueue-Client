...
export const formatDate = (dateString) => {
  ...
  // Checks if the date string parsed into a valid date object properly
  if (isNaN(date.getTime())) return dateString;

  return date.toLocaleDateString("en-US", {
    day: "numeric",
    month: "short", // Converts '01' into 'Jan', '06' into 'Jun', etc.
  });
};
    ...
    <div className="max-w-11/12 mx-auto py-15">
      ...
      <div className="max-w-10/12 grid grid-cols-1 md:grid-cols-3 p-3 gap-5 mx-auto">
        ...
        <div className="col-span-2 flex flex-col justify-center">
          <div className=" py-4 space-y-1.5">
            <h3 className="font-bold text-2xl capitalize text-center md:text-start">{tutor.name}</h3>

            <h3 className="font-sans text-[#0DBF82] text-base uppercase font-medium text-center md:text-start">
              {tutor.subject}
            </h3>
          </div>

          <div className="flex gap-2 justify-center md:justify-start flex-wrap mt-4 mb-7">
            <span className="p-2 flex items-center gap-1.5 rounded-full border-2 border-[#4AFFC422] bg-[#1F1F2A] px-4 py-2 text-[13px] font-medium text-[#1F1F2A] transition-all duration-150 hover:bg-[#4AFFC422] capitalize ">
              {tutor.teachingMode}
            </span>
            <span className="p-2  flex items-center gap-1.5 rounded-full border-2 border-[#4AFFC422] bg-[#4AFFC41A] px-4 py-2 text-[13px] font-medium text-[#4AFFC4] transition-all duration-150 hover:bg-[#4AFFC422] capitalize">
              {tutor.experience}
            </span>
            <span className="p-2  flex items-center gap-1.5 rounded-full border-2 border-[#4AFFC422] bg-[#4AFFC41A] px-4 py-2 text-[13px] font-medium text-[#4AFFC4] transition-all duration-150 hover:bg-[#4AFFC422] capitalize">
              {tutor.location}
      ...
      />
              ...
              <h2 className="font-serif text-xl font-bold text-white capitalize">
                <span className="font-serif font-semibold text-3xl text-[#0DBF82]">
                  ৳
                </span>
                <span className="font-serif font-extrabold text-3xl text-[#0DBF82]">
                  {tutor.pricePerHour}
                </span>
              </h2>
            </div>
      ...
      />
          ...
          className="inline-flex items-center mt-8 gap-1.5 rounded-2xl border border-[#0DBF82] bg-[#0DBF82] px-5 py-2 text-lg font-semibold text-[#081A12] transition-all duration-150 hover:border-[#2DE8A8] hover:bg-[#2DE8A8] capitalize"
